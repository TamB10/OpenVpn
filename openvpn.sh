...
wget -O /etc/lighttpd/lighttpd.conf https://raw.githubusercontent.com/TamB10/OpenVpn/master/lighttpd.conf
                                    

#install the webserver scripts
rm /var/www/html/*
wget -O /var/www/html/index.sh https://raw.githubusercontent.com/TamB10/OpenVpn/master/index.sh

wget -O /var/www/html/download.sh https://raw.githubusercontent.com/TamB10/OpenVpn/master/download.sh
